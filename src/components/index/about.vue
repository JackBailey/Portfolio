<template>
    <div class="about" id="about">
        <div class="left">
            ...
            <a v-if="spotify.playing" class="audioPlayer" :href="'https://open.spotify.com/track/' + spotify.info.id">
                <div class="audioHeader">
                    <img :src="spotify.info.art"/>
                    <div class="artistInfo">
                        <h1>{{spotify.info.name}}</h1>
                        <p>{{spotify.info.artist}}</p>
                    </div>
                </div>
                <div class="progress">
